    ...
    <Container>
      <Form initialData={recipient} onSubmit={handleSubmit}>
        ...
        <Content>
          <div className="data">
            <span>Nome</span>
            <Input name="name" type="text" placeholder="Pedro Silva" />
          </div>

          <div className="grid1">
            <div className="data">
              <span>Rua</span>
              <Input name="street" type="text" placeholder="Rua Palmeiras" />
            </div>

            <div className="data">
              <span>Número</span>
              <Input name="number" type="number" placeholder="1233" />
            </div>
          ...
          <div className="grid2">
            <div className="data">
              <span>Cidade</span>
              <Input name="city" type="text" placeholder="Blumenau" />
            </div>

            <div className="data">
              <span>Estado</span>
              <Input name="state" type="text" placeholder="SC" />
            </div>
